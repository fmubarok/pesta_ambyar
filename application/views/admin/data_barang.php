<div class="container-fluid">
    <button class="btn btn-sm btn-primary mb-3" data-toggle="modal" data-target="#tambah_barang"><i class="fas fa-plus fa-sm"></i> Tambah Tiket
</button>
    ...
    <table class="table table-bodered">
        ...
        <tr>
            ...
            <td><?php echo anchor('admin/dashboard/detail/' . $brg->id_brg, '
